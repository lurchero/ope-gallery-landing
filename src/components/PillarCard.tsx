...
export default function PillarCard({ number, title, description }: PillarCardProps) {
  return (
    <div className="group border border-neutral-800 bg-[#0f0f0f] p-10 transition-all hover:-translate-y-1 hover:border-accent hover:shadow-[0_20px_60px_rgba(0,0,0,0.45)]">
